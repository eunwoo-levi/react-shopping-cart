...
async function callDataStrategyImpl(dataStrategyImpl, request, matches, fetcherKey, scopedContext, isStaticHandler) {
  ...
  let unstable_runClientMiddleware = (cb2) => {
...
const ButtonStyles = newStyled.button`
  ...
  cursor: pointer;
`;
const ConfirmationContainer = newStyled.div`
  width: 100%;
  min-height: 100vh;
  display: flex;
  flex-direction: column;
`;
const ConfirmationSection = newStyled.main`
  width: 100%;
  flex: 1;
  display: flex;
  flex-direction: column;
  ...
  gap: 20px;
`;
const ConfirmationTitle = newStyled.h1`
  font-size: 24px;
  font-weight: 700;
`;
const ConfirmationQuantity = newStyled.div`
  font-size: 12px;
  font-weight: 500;
`;
const ConfirmationTotalPurchasePriceLabel = newStyled.span`
  font-size: 16px;
  font-weight: 700;
`;
const ConfirmationTotalPurchasePrice = newStyled.div`
  font-size: 24px;
  font-weight: 700;
`;
const ConfirmationFooterContainer = newStyled.footer`
  width: 100%;
  height: 64px;
`;
const getSelectedCartItemsFromLocalStorage = () => {
  const cartItems = localStorage.getItem("selected-cart-items");
  return cartItems ? JSON.parse(cartItems) : [];
};
const saveSelectedCartItemsToLocalStorage = (cartItems) => {
...
const CartProvider = ({ children }) => {
  ...
  const updateCartItems = (cartItems2) => {
    setCartItems(cartItems2);
  };
  const updateCartItemQuantity = (cartItem, quantity) => {
    setCartItems((prevItems) => {
      return prevItems.map((item) => item.id === cartItem.id ? { ...item, quantity } : item);
    });
  };
  const updateSelectedCartItem = (cartItem, quantity) => {
  ...
  const updateDeliveryFee = (deliveryFee2) => {
    setDeliveryFee(deliveryFee2);
  };
  const updateTotalPurchasePrice = (totalPurchasePrice2) => {
    setTotalPurchasePrice(totalPurchasePrice2);
  };
...
function ConfirmationPage() {
  ...
  return /* @__PURE__ */ jsxs(ConfirmationContainer, { children: [
    /* @__PURE__ */ jsxs(ConfirmationSection, { children: [
      /* @__PURE__ */ jsx2(ConfirmationTitle, { children: "주문 확인" }),
      /* @__PURE__ */ jsxs(ConfirmationQuantity, { children: [
        "총 ",
        cartTypeQuantity,
        "종류의 상품 ",
        totalQuantity,
      ...
      /* @__PURE__ */ jsx2(ConfirmationQuantity, { children: "최종 결제 금액을 확인해 주세요." }),
      /* @__PURE__ */ jsx2(ConfirmationTotalPurchasePriceLabel, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxs(ConfirmationTotalPurchasePrice, { children: [
        totalPurchasePrice.toLocaleString(),
        "원"
      ] })
    ] }),
    /* @__PURE__ */ jsx2(ConfirmationFooterContainer, { children: /* @__PURE__ */ jsx2(Button, { onClick: handleClick, title: "결제하기", css: ButtonCSS$2, disabled: selectedCartItems.length === 0 }) })
  ] });
}
...
const CartHeaderContent = newStyled.span`
  ...
  font-weight: 500;
`;
function CartHeader({ cartTypeQuantity }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CartHeaderContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartHeaderTitle, { children: "장바구니" }),
    cartTypeQuantity > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(CartHeaderContent, { children: `현재 ${cartTypeQuantity}종류의 상품이 담겨있습니다.` })
  ] });
}
function SelectInput({ ...rest }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectInputBox, { ...rest });
}
...
`;
const CartItemContainer = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 12px;
...
`;
const CartItemHeader = newStyled.div`
  width: 100%;
  height: 24px;
  display: flex;
...
const API_KEY = "ZXVud29vLWxldmk6cGFzc3dvcmQ";
...
function CartItemQuantitySelector({ cartItem }) {
  ...
  const handleCartItemQuantityUpdate = async (id2, quantity) => {
    try {
      await updateCartItem(id2, quantity);
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItemQuantityContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemQuantitySelectorButton, { onClick: handleQuantityMinus, children: "-" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemQuantityNumber, { "data-testid": "card-item-quantity", children: cartItem.quantity }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemQuantitySelectorButton, { onClick: handleQuantityPlus, children: "+" })
  ] });
}
...
function CartItemCard({ cartItem }) {
  ...
  const handleSelectedCartItemUpdate = (e2) => {
  ...
  return /* @__PURE__ */ jsxs(CartItemContainer, { "data-testid": "cart-item-card", children: [
    /* @__PURE__ */ jsxs(CartItemHeader, { children: [
      /* @__PURE__ */ jsx2(SelectInput, { type: "checkbox", onChange: handleSelectedCartItemUpdate, checked: isSelected }),
      /* @__PURE__ */ jsx2(Button, { title: "삭제", css: deleteButtonCSS, onClick: handleCartItemDelete })
    ] }),
    /* @__PURE__ */ jsxs(CartItemContent, { children: [
      /* @__PURE__ */ jsx2(
        CartItemImage,
        {
      ...
      /* @__PURE__ */ jsxs(CartItemInfo, { children: [
        /* @__PURE__ */ jsxs(CartItemInfoDetails, { children: [
          /* @__PURE__ */ jsx2(CartItemInfoName, { "data-testid": "cart-item-name", children: cartItem.product.name }),
          /* @__PURE__ */ jsxs(CartItemInfoPrice, { "data-testid": "card-item-price", children: [
            cartItem.product.price.toLocaleString(),
            "원"
          ] })
        ] }),
        /* @__PURE__ */ jsx2(CartItemQuantitySelector, { cartItem, isSelected })
      ] })
    ] })
  ] });
}
...
`;
function Footer({ title, url, cartItemQuantity, selectedCartItems }) {
  const navigate = useNavigate();
  const handleClick = () => {
    navigate(url);
  };
  return /* @__PURE__ */ jsx2(FooterContainer, { children: /* @__PURE__ */ jsx2(
    Button,
    {
      onClick: handleClick,
      title,
...
function EmptyCartItemUI() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCartItemUIContainer, { children: "장바구니에 담은 상품이 없습니다." });
}
...
function Navbar({ title, url }) {
  ...
  return /* @__PURE__ */ jsx2(NavbarContainer, { onClick: handleClick, children: /* @__PURE__ */ jsx2(Button, { css: ButtonCSS, title, onClick: handleClick }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CartPageContainer, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CartPageContent, { children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(CartListSkeleton, {}) : cartItems.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(CartListSkeleton, {}), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartList, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPriceSummary$2, {})
...
const OrderPageContainer = newStyled.div`
  width: 100%;
  min-height: 100vh;
  display: flex;
  flex-direction: column;
  align-items: center;
`;
const OrderPageContent = newStyled.main`
  width: 100%;
  flex: 1;
  display: flex;
  flex-direction: column;
  ...
  padding: 30px 24px;
`;
const ReviewCartListContainer = newStyled.section`
  width: 100%;
  flex: 1;
  display: flex;
  flex-direction: column;
  gap: 20px;
`;
const ReviewCartItemCardContainer = newStyled.div`
  width: 100%;
  height: 350px;
  overflow-y: auto;
  display: flex;
  ...
  gap: 12px;
`;
const ReviewCartItemContainer = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 12px;
...
`;
const ReviewCartItemContent = newStyled.div`
  width: 100%;
  flex: 1;
  display: flex;
  gap: 25px;
`;
const ReviewCartItemImage = newStyled.img`
  width: 112px;
  height: 112px;
  object-fit: cover;
  border-radius: 8px;
`;
const ReviewCartItemInfo = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
`;
const ReviewCartItemInfoDetails = newStyled.div`
  display: flex;
  flex-direction: column;
  gap: 14px;
`;
const ReviewCartItemInfoName = newStyled.span`
  font-size: 16px;
  font-weight: 500;
`;
const ReviewCartItemInfoPrice = newStyled.span`
  font-size: 24px;
  font-weight: 700;
`;
const ReviewCartItemInfoQuantity = newStyled.span`
  font-size: 14px;
  font-weight: 500;
`;
function ReviewCartItemCard({ selectedCartItem }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartItemContainer, { "data-testid": "cart-item-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ReviewCartItemContent, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReviewCartItemImage,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartItemInfo, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ReviewCartItemInfoDetails, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartItemInfoName, { "data-testid": "cart-item-name", children: selectedCartItem.product.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ReviewCartItemInfoPrice, { "data-testid": "card-item-price", children: [
        selectedCartItem.product.price.toLocaleString(),
        "원"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ReviewCartItemInfoQuantity, { "data-testid": "cart-item-quantity", children: [
...
function ReviewCartList({ selectedCartItems }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartListContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartItemCardContainer, { children: selectedCartItems.map((selectedCartItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCartItemCard, { selectedCartItem }, selectedCartItem.id)) }) });
}
const Overlay = newStyled.div`
  ...
  display: flex;
  justify-content: center;
  align-items: ${({ position: position2 }) => position2 === "center" ? "center" : "flex-end"};
`;
const ModalContainer = newStyled.div`
  ...
  ${({ position: position2 }) => position2 === "bottom" ? `
    width: 100%;
...
newStyled.main`
  ...
  gap: 24px;
`;
function CustomModal({ isOpen, onClose, position: position2 = "center", children }) {
  reactExports.useEffect(() => {
  ...
  return reactDomExports.createPortal(
    /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { position: position2, onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalContainer, { position: position2, onClick: (e2) => e2.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children }) }) }),
    document.body
  );
}
const CouponListContainer = newStyled.div`
  ...
  gap: 16px;
`;
const CouponListContent = newStyled.div`
  width: 100%;
  height: 400px;
  overflow-y: auto;
  display: flex;
  ...
  gap: 16px;
`;
const CouponListHeader = newStyled.div`
  width: 100%;
  display: flex;
  justify-content: space-between;
  align-items: center;
  ...
  font-weight: 700;
`;
const CouponIcon = newStyled.img`
  width: 16px;
  height: 16px;
  margin-right: 8px;
  vertical-align: middle;
`;
const CouponLabel = newStyled.span`
  width: 100%;
  font-size: 12px;
  font-weight: 500;
...
`;
const CouponHeader = newStyled.div`
  width: 100%;
  display: flex;
  justify-content: start;
  align-items: center;
...
const CouponInfo = newStyled.div`
  ...
  padding-top: 10px;
`;
const CouponListFooterContainer = newStyled.div`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
`;
const UseCouponButton = newStyled.button`
  width: 100%;
  padding: 16px 0;
    ...
    case "buyXgetY": {
      ...
      if (cartItem.quantity <= coupon.buyQuantity) {
        updateMessage && updateMessage(
          `${coupon.getQuantity + coupon.buyQuantity - cartItem.quantity}개 더 구매 시 ${coupon.getQuantity}개 무료 증정!`
        );
        return 0;
      }
...
const calculateTotalDiscountPrice = ({
  ...
  return selectedCoupons.reduce(
    (acc, coupon) => acc + getCouponDiscountPrice({
      coupon,
...
const validateExpirationDate = (currentDate, couponDate) => {
...
const validateAvailableTime = (currentDate, availableTime) => {
...
const validateMinimumAmount = (totalPrice, coupon) => {
...
const useCoupons = () => {
  ...
  const [isCouponLoading, setIsCouponLoading] = reactExports.useState(false);
  ...
  const getInvalidCouponIds = (totalPrice) => {
    const currentDate = /* @__PURE__ */ new Date();
    return coupons.filter(
      (coupon) => !validateExpirationDate(currentDate, coupon.expirationDate) || coupon.availableTime && !validateAvailableTime(currentDate, coupon.availableTime) || coupon.minimumAmount && !validateMinimumAmount(totalPrice, coupon)
    ).map((coupon) => coupon.id);
  };
  const getBestTwoCoupons = (cartItem, totalPrice, deliveryFee) => {
    ...
    couponsWithDiscountPrice.sort((a, b2) => b2.discountPrice - a.discountPrice);
...
function CouponList({ onClose }) {
  ...
  reactExports.useEffect(() => {
    ...
    const totalDiscountPrice2 = bestTwo.reduce((acc, bestCoupon) => acc + bestCoupon.discountPrice, 0);
    updateTotalDiscountPrice(totalDiscountPrice2);
    updateSelectedCoupons(bestTwo.map((bestCoupon) => bestCoupon.coupon));
    updateTotalPurchasePrice(totalPrice + deliveryFee - totalDiscountPrice2);
  }, [coupons, deliveryFee]);
  reactExports.useEffect(() => {
    updateTotalDiscountPrice(
  ...
  return /* @__PURE__ */ jsxs(CouponListContainer, { children: [
    /* @__PURE__ */ jsxs(CouponListHeader, { children: [
      "쿠폰을 선택해주세요.",
      /* @__PURE__ */ jsx2(Button, { onClick: handleCloseModal, title: "X", css: CloseButtonCSS })
    ] }),
    /* @__PURE__ */ jsxs(CouponLabel, { children: [
      /* @__PURE__ */ jsx2(CouponIcon, { src: "./infoLabelIcon.svg", alt: "Coupon Label Icon" }),
      "쿠폰은 최대 2개까지 사용할 수 있습니다."
    ] }),
    /* @__PURE__ */ jsx2(CouponListContent, { children: isCouponLoading ? /* @__PURE__ */ jsx2("span", { children: "쿠폰 목록 불러오는 중..." }) : coupons.map((coupon) => /* @__PURE__ */ jsxs(CouponContainer, { isInvalid: invalidCouponIds.includes(coupon.id), children: [
      /* @__PURE__ */ jsxs(CouponHeader, { children: [
        /* @__PURE__ */ jsx2(
          SelectInput,
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ jsxs(CouponInfo, { children: [
        /* @__PURE__ */ jsxs("span", { children: [
          "만료일: ",
          coupon.expirationDate
        ] }),
        coupon.minimumAmount && /* @__PURE__ */ jsxs("span", { children: [
          "최소 주문 금액: ",
          coupon.minimumAmount.toLocaleString()
        ] }),
        coupon.availableTime && /* @__PURE__ */ jsxs("span", { children: [
          "사용 가능 시간: 오전 ",
          coupon.availableTime.start[1],
          "시부터 ",
          coupon.availableTime.end[1],
          "까지"
        ] }),
        message.length !== 0 && coupon.discountType === "buyXgetY" && /* @__PURE__ */ jsxs(messageContainer, { children: [
          " ",
          message,
          " "
        ] })
    ...
    /* @__PURE__ */ jsx2(CouponListFooterContainer, { children: /* @__PURE__ */ jsxs(UseCouponButton, { onClick: handleCouponUsage, disabled: selectedCoupons.length === 0, css: CouponButtonCSS$1, children: [
      "총 ",
...
const DELIVERY_FEE_THRESHOLD = 1e5;
...
const OrderPriceSummaryContainer = newStyled.section`
  ...
  gap: 10px;
`;
const SuburbExtraFeeContainer = newStyled.div`
  width: 100%;
  display: flex;
  ...
  gap: 10px;
`;
const DeliveryFeeHeaderLabel = newStyled.div`
  font-size: 16px;
  font-weight: 700;
`;
const DeliveryFeeLabel = newStyled.div`
  width: 100%;
  padding: 10px 0;
  display: flex;
  align-items: center;
  font-size: 16px;
`;
const DeliveryFeeIcon = newStyled.img`
  width: 16px;
  height: 16px;
  margin-right: 8px;
  vertical-align: middle;
...
const TotalOrderPrice = newStyled.div`
  ...
  padding-top: 12px;
`;
const CouponDiscountAmount = newStyled.div`
  ${baseStyle}
`;
const DeliveryFee = newStyled.div`
  ${baseStyle}
  border-bottom: 2px solid rgba(0, 0, 0, 0.1);
  padding-bottom: 12px;
`;
const TotalPurchasePrice = newStyled.div`
  ${baseStyle}
`;
...
function OrderPriceSummary({ useCoupon = false }) {
  ...
  const handleSuburbExtraFeeChange = (e2) => {
    const isChecked = e2.target.checked;
    setSuburbExtraFee(isChecked ? DELIVERY_FEE : 0);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPriceSummaryContainer, { children: [
    useCoupon && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryFeeHeaderLabel, { children: "배송 정보" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SuburbExtraFeeContainer, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectInput, { type: "checkbox", onChange: handleSuburbExtraFeeChange }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryFeeLabel, { children: "제주도 및 도서 산간 지역" })
      ] })
    ] }),
    ...
    useCoupon && /* @__PURE__ */ jsxRuntimeExports.jsxs(CouponDiscountAmount, { "data-testid": "coupon-discount-amount", children: [
      "쿠폰 할인 금액",
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceBox, { children: [
        "-",
        totalDiscountPrice.toLocaleString(),
...
const OrderPriceSummary$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: OrderPriceSummary
  ...
  return /* @__PURE__ */ jsxs(OrderPageContainer, { children: [
    ...
    /* @__PURE__ */ jsxs(OrderPageContent, { "data-testid": "order-page-content", children: [
      ...
      selectedCartItems.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx2(Button, { onClick: () => setIsModalOpen(!isModalOpen), title: "쿠폰 적용", css: CouponButtonCSS }),
        /* @__PURE__ */ jsx2(OrderPriceSummary, { useCoupon: true })
      ] }) : /* @__PURE__ */ jsx2(EmptyCartItemUI, {})
    ] }),
    /* @__PURE__ */ jsx2(
      Footer,
      {
    ...
    isModalOpen && /* @__PURE__ */ jsx2(CustomModal, { isOpen: isModalOpen, onClose: () => setIsModalOpen(false), position: "center", children: /* @__PURE__ */ jsx2(CouponList, { onClose: () => setIsModalOpen(false) }) })
  ] });
}
const router = createBrowserRouter(
  createRoutesFromElements(
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: ROUTES.ROOT, element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: ROUTES.REVIEW, element: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderReviewPage, {}) }),
...
enableMocking().then(() => {
  client.createRoot(document.getElementById("root")).render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) })
  );
});
export {
